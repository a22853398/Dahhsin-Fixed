...
$title02 = strip_input('inputadm',$_REQUEST['title02']);
  ...
  switch ($opt) {
	case 'add':
		...
		$strSQL1  ="insert into ".$table_name." (serialid,lv00_type,sortid,title01,title02,member_area,member_id,add_ipaddress,add_date,update_ipaddress,update_date) values(";
		$strSQL1 .="'". $nextval_id ."',";
		$strSQL1 .="'". $lv00_type ."',";
		$strSQL1 .="'". $sortid ."',";
		$strSQL1 .="'". $title01 ."',";
