...
///分頁處理START///
$str_countSql = "SELECT COUNT(*) FROM (".$sqlStr_couponAccountHave.") AS tmp";
$int_sqlRes_count = GetQueryValueCount1($str_countSql ,"value");
$page = strip_input('inputadm',$_REQUEST['page']);  
$page_splt01 = 8;
pageft($int_sqlRes_count, $page_splt01);
$res_couponAccountHave = SqlQueryLimit1($sqlStr_couponAccountHave, $displaypg, $firstcount);
...
if (isset($_SESSION['session_webmbr_login_id']) && $_SESSION['session_webmbr_login_id'] != ''){
    $tpl->display('member_couponHave.shtm');
}else{
